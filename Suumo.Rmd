...
setwd("D:/github/Suumo_Enshu") 
df <- read.csv("hamamatsu.csv", fileEncoding = "UTF-16", sep = "\t") #前処理したデータを読み込み
names(df) <- c("index", "name","address","ward","city","rooms","DK","K","L","S","age","height","order","area","rent_adm",
               ...
               "rent","administration","deposit","gratuity","security")
#               "rent","administration","deposit","gratuity","security","non_refund","depreciation") 
#英語でカラム名付け替え
